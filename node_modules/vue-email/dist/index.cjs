...
const ETailwind = vue.defineComponent({
  ...
  async setup(props, { slots }) {
    ...
    return () => {
      return vue.h("clean-component", { innerHTML: html });
    };
  }
});
...
const ECodeBlock = vue.defineComponent({
  name: "ECodeBlock",
  props: {
    code: {
      type: String,
...
const ECodeInline = vue.defineComponent({
  name: "ECodeInline",
  props: {
    class: {
      type: String,
...
async function useRender(component, params, options = {
  ...
  if (params?.components) {
    for (const [name, component2] of Object.entries(params.components))
...
exports.ECodeBlock = ECodeBlock;
exports.ECodeInline = ECodeInline;
